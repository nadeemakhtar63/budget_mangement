...
class ExpenseMonths extends StatefulWidget {
  String selectedYear;
  // budgetDao dio;
  //ExpenseMonth({Key key, this.selectedYear,  budgetDao deo}):super(key: key);
  @override
  _ExpenseMonthsState createState() => _ExpenseMonthsState();
}

class _ExpenseMonthsState extends State<ExpenseMonths> {
                            ...
                            builder: (context,index){
                              ...
                              else
                              {
                                ...
                                return StreamBuilder<List<ExpEntity>>(
                                    stream: index.data.expdio.expPrevsMonths(cchk).asStream(),
                                    builder: (BuildContext context,AsyncSnapshot <List<ExpEntity>> snapshot){
                                      var listExpnse=snapshot.data as List<ExpEntity>;
